...
sum(edades)
# esto es más conveniente que hacerlo a mano:
31+34+56
edades[1]+edades[2]+edades[3]
sum(edades)

# obtener el tipo de los datos de un vector
typeof(edades)
class(edades)
...
# sirve para, por ejemplo, obtener un subconjunto que vaya desde el
# elemento x al último elemento
edades[4:length(edades)]
# o para extraer el último elemento
